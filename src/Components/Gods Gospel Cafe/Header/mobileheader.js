...
// Image imports
import BackgroundImage from "../../../images/mobile-header/mobile-header-background.jpg";
import LogoImage from "../../../images/mobile-header/mobile-logo.png";
import ContentImage from "../../../images/mobile-header/mobile-header-content.png";
